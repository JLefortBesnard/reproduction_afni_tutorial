...
def compare2brik(brik1_path, brik2_path):
    ...
    print('----#####-----')
    print('brik1 == brik2 :')
    return np.array_equal(brik1_data, brik2_data)
    time.sleep(2)
...
for run in runs:
    ...
    # check output
    compare2text(3, opj(path_afni_preprocessed_files, 'outcount.r0{}.1D'.format(run)), 'outcount.r0{}.1D'.format(run))
    ...
    compare2text(3, opj(path_afni_preprocessed_files, "out.pre_ss_warn.txt"), "out.pre_ss_warn.txt")
...
compare2text(3, opj(path_afni_preprocessed_files, 'outcount_rall.1D'), 'outcount_rall.1D')
...
with open('outcount_{}_censor.1D'.format(sub), 'w') as outfile:
    for fname in filenames:
        with open(fname) as infile:
            outfile.write(infile.read()+'\n')
compare2text(3, opj(path_afni_preprocessed_files, 'outcount_{}_censor.1D'.format(sub)), 'outcount_{}_censor.1D'.format(sub))
...
compare2text(3, opj(path_afni_preprocessed_files, "out.min_outlier.txt"), "out.min_outlier.txt")
