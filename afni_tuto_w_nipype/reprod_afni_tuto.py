...
def compare2text(txt1_path, txt2_path, nb_lines_to_compare):
    # reading files
...
"""missing functions in nipype thus copied
# ---------------------------------------------------------
...
dst = 'outcount_{}_censor.1D'.format(sub)
...
compare2text("/home/jlefortb/reproduction_afni_tutorial/afni_tuto_w_afni/FT.results/{}".format("FT_anat_ns.Xat.1D"), "FT_anat_ns.Xat.1D") # TRUE
...
compare2brik(opj(path_afni_preprocessed_files, 'mask_epi_extents+tlrc.BRIK.gz'), 'mask_epi_extents+tlrc.BRIK.gz')
...
tstat.inputs.out_file = 'rm.noise.vreg.r01+tlrc.BRIK'
tstat.cmdline
# should be
...
calc.inputs.out_file =  'TSNR.vreg.r01.{}+tlrc.BRIK'.format(sub)
calc.cmdline
# should be
...
res = aboverlap.run() 
compare2text(opj(path_afni_preprocessed_files, "out.mask_ae_overlap.txt"),"out.mask_ae_overlap.txt") # TRUE
...
!3ddot -dodice full_mask.FT+tlrc mask_anat.FT+tlrc               \
      |& tee out.mask_ae_dice.txt
compare2text(opj(path_afni_preprocessed_files, "out.mask_ae_dice.txt"),"out.mask_ae_dice.txt") # TRUE
...
!3ddot -dodice mask_anat.FT+tlrc mask_group+tlrc                    \
      |& tee out.mask_at_dice.txt
compare2text(opj(path_afni_preprocessed_files, "out.mask_at_dice.txt"),"out.mask_at_dice.txt") # TRUE
...
res = odt.run() 
compare2text(opj(path_afni_preprocessed_files, 'mot_demean.r02.1D'),'mot_demean.r02.1D') # TRUE
...
res = odt.run() 
compare2text(opj(path_afni_preprocessed_files, 'motion_FT_enorm.1D'),'motion_FT_enorm.1D') # TRUE
compare2text(opj(path_afni_preprocessed_files, 'motion_FT_CENSORTR.txt'),'motion_FT_CENSORTR.txt') # TRUE
...
res = eval.run() 
compare2text(opj(path_afni_preprocessed_files, 'censor_{}_combined_2.1D'.format(sub)),'censor_{}_combined_2.1D'.format(sub)) # TRUE
"""
...
compare2text(opj(path_afni_preprocessed_files, 'X.xmat.1D'),'X.xmat.1D') # TRUE
...
res = odt.run() 
compare2text(opj(path_afni_preprocessed_files, 'out.cormat_warn.txt'),'out.cormat_warn.txt') # TRUE
...
res = odt.run() 
compare2text(opj(path_afni_preprocessed_files, 'out.df_info.txt'),'out.df_info.txt') # TRUE
...
#          > mean.errts.unit.1D
res = maskave.run()  
compare2text(opj(path_afni_preprocessed_files, 'mean.errts.unit.1D'),'mean.errts.unit.1D') # TRUE
...
compare2text(opj(path_afni_preprocessed_files, 'out.gcor.1D'),'out.gcor.1D') # TRUE
...
#           > mean.errts.1D
res = maskave.run()  
compare2text(opj(path_afni_preprocessed_files, 'mean.errts.1D'),'mean.errts.1D') # TRUE
...
res = cat1d.run()  
compare2text(opj(path_afni_preprocessed_files, 'ideal_vis.1D'),'ideal_vis.1D') # TRUE
...
res = cat1d.run()  
compare2text(opj(path_afni_preprocessed_files, 'ideal_aud.1D'),'ideal_aud.1D') # TRUE
...
res = odt.run() 
compare2text(opj(path_afni_preprocessed_files, 'X.stim.xmat.1D'),'X.stim.xmat.1D') # TRUE
...
res = tstat.run()
compare2text(opj(path_afni_preprocessed_files, 'sum_ideal.1D'),'sum_ideal.1D') # TRUE
...
compare2text(opj(path_afni_preprocessed_files, 'files_ACF/out.3dFWHMx.ACF.epits.r01.1D'),'files_ACF/out.3dFWHMx.ACF.epits.r01.1D') # TRUE
compare2text(opj(path_afni_preprocessed_files, 'files_ACF/out.3dFWHMx.ACF.epits.r02.1D'),'files_ACF/out.3dFWHMx.ACF.epits.r02.1D') # TRUE
compare2text(opj(path_afni_preprocessed_files, 'files_ACF/out.3dFWHMx.ACF.epits.r03.1D'),'files_ACF/out.3dFWHMx.ACF.epits.r03.1D') # TRUE
compare2text(opj(path_afni_preprocessed_files, 'blur.epits.1D'),'blur.epits.1D') # TRUE
...
compare2text(opj(path_afni_preprocessed_files, 'files_ACF/out.3dFWHMx.ACF.errts.r01.1D'),'files_ACF/out.3dFWHMx.ACF.errts.r01.1D') # TRUE
compare2text(opj(path_afni_preprocessed_files, 'files_ACF/out.3dFWHMx.ACF.errts.r02.1D'),'files_ACF/out.3dFWHMx.ACF.errts.r02.1D') # TRUE
compare2text(opj(path_afni_preprocessed_files, 'files_ACF/out.3dFWHMx.ACF.errts.r03.1D'),'files_ACF/out.3dFWHMx.ACF.errts.r03.1D') # TRUE
compare2text(opj(path_afni_preprocessed_files, 'blur.errts.1D'),'blur.errts.1D') # TRUE
...
compare2text(opj(path_afni_preprocessed_files, 'blur_est.FT.1D'),'blur_est.FT.1D') # TRUE
...
!gen_epi_review.py -script @epi_review.FT \
    -dsets pb00.$subj.r*.tcat+orig.HEAD
compare2text(opj(path_afni_preprocessed_files, '@epi_review.FT'),'@epi_review.FT') # TRUE
...
compare2text(opj(path_afni_preprocessed_files, "out.ap_uvars.txt"),"out.ap_uvars.txt") # TRUE
...
compare2text(opj(path_afni_preprocessed_files, "out.ap_uvars.json"),"out.ap_uvars.json") # TRUE
